...
public class Conta {
    ...
    public static void Transferir(String cpf, String para, String da, boolean errou) {
        Interface.Limpar();
        String datipoextenso = da.equals("CC") ? "Conta-corrente" : (da.equals("CP") ? "Conta-poupan�a" : (da.equals("CI") ? "Conta-investimento" : ""));
        String paratipoextenso = para.equals("CC") ? "Conta-corrente" : (para.equals("CP") ? "Conta-poupan�a" : (para.equals("CI") ? "Conta-investimento" : "PIX"));
        System.out.println("................................");
        System.out.println("Transferencia da "+datipoextenso+" para "+ paratipoextenso);
        System.out.println("................................");
        System.out.println("Saldo Disponi�vel: " + dinheiro.format(((da.equals("CC") ? Double.parseDouble(BancoDeDados.pegarSaldoCC(BancoDeDados.pegarConta(cpf))) : (da.equals("CP") ? Double.parseDouble(BancoDeDados.pegarSaldoCP(BancoDeDados.pegarConta(cpf))) : (da.equals("CI") ? Double.parseDouble(BancoDeDados.pegarSaldoCI(BancoDeDados.pegarConta(cpf))) : ""))))));
        Scanner ler = new Scanner(System.in);
        if (errou) {
